...
(function (Resource_1) {
    ...
    var Resource = (function () {
        function Resource(resDef) {
            this.baseUrl = Resource.BASE_URL;
        ...
        Resource.prototype.setupRecursiveRoutes = function () {
            var _this = this;
            var resource = this.parentResource;
            if (!!resource) {
        ...
        Resource.prototype.buildPopulateQuery = function (req) {
