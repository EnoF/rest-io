...
var AuthorizedSubResource = (function (_super) {
    ...
    AuthorizedSubResource.prototype.update = function (req, res) {
        ...
        this.isAuthorized(req, this.permissions.update)
            .then(function () { return SubResource.prototype.update.call(_this, req, res); }, function (err) { return _this.sendUnauthorized(err, res); });
    };
    AuthorizedSubResource.prototype.del = function (req, res) {
        var _this = this;
        this.isAuthorized(req, this.permissions.del)
            .then(function () { return SubResource.prototype.del.call(_this, req, res); }, function (err) { return _this.sendUnauthorized(err, res); });
    };
